...
%LocalAppData%\Arduino15\packages\arduino\tools\avrdude\6.3.0-arduino18/bin/avrdude -Cavrdude.conf -v -pattiny85 -cstk500v1 -PCOM4 -b19200 -Uflash:w:AT852LFO.ino.hex:i -Ulfuse:w:0x62:m -Ulock:w:0xFF:m 
